...
const PROVIDERS = [
  { id: 'odido', naam: 'Odido', browser: true, urls: [
      'https://www.odido.nl/service/bellen-en-internetten-in-het-buitenland',
      'https://www.odido.nl/prive/mobiel/buitenland' ] },
